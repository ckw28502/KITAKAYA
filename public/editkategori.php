...
<?php
    ...
    $kat = Video::getKategoribyId($idkategori);
...
<body>
    <div id="layoutSidenav_content">
        <main>
                <h1 style="text-align: center">Edit Kategori</h1><br><br>
                <div style="padding-left: 40%;">
                    <form action="../controllers/vid.php" method="POST">
                        <label for="fname">Nama Kategori</label>
                        <input type="text" id="fname" name="namakategori" value="<?=$kat->nama_kategori?>">
                        <button type="submit" class="btn btn-success" name="btnsave" id="kembali">Save</button>
                    </form>
                </div>
